...
using Snow.Template.Localization.Dto;

namespace Snow.Template.Localization
{
    [AbpAuthorize(PermissionNames.Pages_Administration_Languages)]
    public class LanguageAppService : TemplateAppServiceBase, ILanguageAppService
    {
        ...
        [AbpAuthorize(PermissionNames.Pages_Administration_Languages_Create, PermissionNames.Pages_Administration_Languages_Edit)]
