...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        ...
        new MenuItem(this.l('Tenants'), 'Pages.Administration.Tenants', 'business', '/app/tenants'),
        new MenuItem(this.l('Users'), 'Pages.Administration.Users', 'people', '/app/users'),
        new MenuItem(this.l('Roles'), 'Pages.Administration.Roles', 'local_offer', '/app/roles'),
        new MenuItem(this.l('MenuItem'), 'Pages.Administration.MenuItems', 'info', '/app/menus'),
