...
using Snow.Template.Web.Models.Account;
using Snow.Template.Web.Views.Shared.Components.TenantChange;

namespace Snow.Template.Web.Controllers.Authorization
{
    public class AccountController : TemplateControllerBase
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = Template.Authorization.Users.User.CreateRandomPassword();
                }
                else
                {
