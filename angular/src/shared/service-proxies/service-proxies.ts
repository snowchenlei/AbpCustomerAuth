...
export class MenuItemServiceProxy {
     ...
     * @return Success
     */
    getList(): Observable<MenuItemListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/MenuItem/GetList";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<MenuItemListDto[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<MenuItemListDto[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetList(response: HttpResponseBase): Observable<MenuItemListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            if (resultData200 && resultData200.constructor === Array) {
                ...
                for (let item of resultData200)
                    result200.push(MenuItemListDto.fromJS(item));
            }
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
        ...
        return _observableOf<MenuItemListDto[]>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | null | undefined, skipCount: number | null | undefined, maxResultCount: number | null | undefined): Observable<PagedResultDtoOfMenuItemListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfMenuItemListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfMenuItemListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfMenuItemListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfMenuItemListDto.fromJS(resultData200) : new PagedResultDtoOfMenuItemListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfMenuItemListDto>(<any>null);
    }
     ...
     * @return Success
     */
    getForEdit(id: number | null | undefined): Observable<GetMenuItemForEditOutput> {
        let url_ = this.baseUrl + "/api/services/app/MenuItem/GetForEdit?";
        if (id !== undefined)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<GetMenuItemForEditOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<GetMenuItemForEditOutput>><any>_observableThrow(response_);
        }));
    }

    protected processGetForEdit(response: HttpResponseBase): Observable<GetMenuItemForEditOutput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? GetMenuItemForEditOutput.fromJS(resultData200) : new GetMenuItemForEditOutput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<GetMenuItemForEditOutput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrUpdate(input: CreateOrUpdateMenuItemInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/MenuItem/CreateOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
...
export class MenuItemListDto implements IMenuItemListDto {
    ...
    constructor(data?: IMenuItemListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MenuItemListDto {
        data = typeof data === 'object' ? data : {};
        let result = new MenuItemListDto();
        result.init(data);
        return result;
    }
...
export interface IMenuItemListDto {
    name: string | undefined;
    parentId: string | undefined;
    parentName: string | undefined;
    permissionName: string | undefined;
...
export class PagedResultDtoOfMenuItemListDto implements IPagedResultDtoOfMenuItemListDto {
    totalCount: number | undefined;
    items: MenuItemListDto[] | undefined;

    constructor(data?: IPagedResultDtoOfMenuItemListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                ...
                for (let item of data["items"])
                    this.items.push(MenuItemListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfMenuItemListDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfMenuItemListDto();
        result.init(data);
        return result;
    }
    ...
    clone(): PagedResultDtoOfMenuItemListDto {
        const json = this.toJSON();
        let result = new PagedResultDtoOfMenuItemListDto();
        result.init(json);
        return result;
...
export interface IPagedResultDtoOfMenuItemListDto {
    totalCount: number | undefined;
    items: MenuItemListDto[] | undefined;
}

export class GetMenuItemForEditOutput implements IGetMenuItemForEditOutput {
    menuItem: MenuItemEditDto | undefined;

    constructor(data?: IGetMenuItemForEditOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.menuItem = data["menuItem"] ? MenuItemEditDto.fromJS(data["menuItem"]) : <any>undefined;
        }
    }

    static fromJS(data: any): GetMenuItemForEditOutput {
        data = typeof data === 'object' ? data : {};
        let result = new GetMenuItemForEditOutput();
        result.init(data);
        return result;
    }
    ...
    clone(): GetMenuItemForEditOutput {
        const json = this.toJSON();
        let result = new GetMenuItemForEditOutput();
        result.init(json);
        return result;
...
export class MenuItemEditDto implements IMenuItemEditDto {
    ...
    constructor(data?: IMenuItemEditDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MenuItemEditDto {
        data = typeof data === 'object' ? data : {};
        let result = new MenuItemEditDto();
        result.init(data);
        return result;
    }
...
export interface IMenuItemEditDto {
    parentId: number | undefined;
    name: string | undefined;
    permissionName: string | undefined;
    icon: string | undefined;
...
export class CreateOrUpdateMenuItemInput implements ICreateOrUpdateMenuItemInput {
    menuItem: MenuItemEditDto;

    constructor(data?: ICreateOrUpdateMenuItemInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (!data) {
            this.menuItem = new MenuItemEditDto();
        }
    }

    init(data?: any) {
        if (data) {
            this.menuItem = data["menuItem"] ? MenuItemEditDto.fromJS(data["menuItem"]) : new MenuItemEditDto();
        }
    }

    static fromJS(data: any): CreateOrUpdateMenuItemInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateOrUpdateMenuItemInput();
        result.init(data);
        return result;
    }
    ...
    clone(): CreateOrUpdateMenuItemInput {
        const json = this.toJSON();
        let result = new CreateOrUpdateMenuItemInput();
        result.init(json);
        return result;
...
export interface ICreateOrUpdateMenuItemInput {
    menuItem: MenuItemEditDto;
}
